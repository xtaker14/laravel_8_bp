$(document).ready(function () {
    ...
    if ($("#inp_is_module").val() == 'no') {
        showHideMethodRoute(null, false);
    } else {
        showHideMethodRouteByModule(null, false);
    }
    // fillAccessAndURL();
...
showHideMethodRoute = (t = null, clear_mvc = true) => {
    if (t == null) {
        t = $("#inp_is_menu");
    }
    let parent_m_controller_name = $("#parent_m_controller_name");
...
showHideMethodRouteByModule = (t = null, clear_input = true) => {
    if (t == null) {
        t = $("#parent_module_name").find('select[name=module_name]');
    }
    let parent_m_controller_name = $("#parent_m_controller_name");
