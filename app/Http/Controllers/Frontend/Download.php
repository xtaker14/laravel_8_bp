...
class Download extends Controller
{
    ...
    public function detail($id_download, $slug_download)
    {
        ...
        $data = [
            ...
            "download" => $download,
            "content" => "frontend/download/detail",
        ];
        return view("frontend/layout/wrapper", $data);
    }
