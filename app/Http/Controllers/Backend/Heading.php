...
{
    protected $category_heading = [
        'Berita' => 'Berita',
        'Agenda' => 'Agenda',
        'Galeri' => 'Galeri',
        'Kontak' => 'Halaman Kontak',
        'AboutUs' => 'Tentang Kami',
        'Team' => 'Halaman Board and Team',
        'Dokumen' => 'Dokumen',
        'Layanan' => 'Layanan',
        'Statistic' => 'Statistik',
    ];
    ...
    public function index()
    {
        ...
        $heading = DB::table("heading")
            ->orderBy("judul_heading", "ASC")
            ->get();

        $data = [
            "title" => "Setting Header",
            "heading" => $heading,
            "content" => "backend/heading/index",
            "category_heading" => $this->category_heading,
        ];
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect("admin/heading")->with([
    ...
    public function edit(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            DB::table("heading")
                ->where("id_heading", $request->id_heading)
                ->update([
                    "judul_heading" => $request->judul_heading,
                    "keterangan" => $request->keterangan,
                    "gambar" => $input["nama_file"],
