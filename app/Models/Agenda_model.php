...
class Agenda_model extends Model
{
    ...
    public function semua()
    {
        $query = DB::table("agenda")
            ->join(
                "kategori_agenda",
                "kategori_agenda.id_kategori_agenda",
                "=",
                "agenda.id_kategori_agenda",
                "LEFT"
            )
            ->join("users", "users.id", "=", "agenda.id_user", "LEFT")
            ->select(
                "agenda.*",
    ...
    public function all_kategori_agenda($id_kategori_agenda)
    {
        $query = DB::table("agenda")
            ...
            ->where(["agenda.id_kategori_agenda" => $id_kategori_agenda])
            ->orderBy("id_agenda", "DESC")
            ->paginate(25);
        return $query;
    }
    ...
    public function status_agenda($status_agenda)
    {
        $query = DB::table("agenda")
            ...
            ->where(["agenda.status_agenda" => $status_agenda])
            ->orderBy("id_agenda", "DESC")
            ->paginate(25);
        return $query;
    }
    ...
    public function jenis_agenda($jenis_agenda)
    {
        $query = DB::table("agenda")
            ...
            ->where(["agenda.jenis_agenda" => $jenis_agenda])
            ->orderBy("id_agenda", "DESC")
            ->paginate(25);
        return $query;
    }
