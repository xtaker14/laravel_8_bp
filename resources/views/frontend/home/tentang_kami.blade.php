<?php 
$bg   = DB::table('heading')->where('halaman','AboutUs')->orderBy('id_heading','DESC')->first();
 ?>
<!--Inner Header Start-->
   ...
   <div class="about-video-section wf100">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-5">
               <a href="#"><img src="{{ asset('assets/upload/image/'.$config_site->gambar) }}" alt="{{ $config_site->nama_singkat }}" class="img img-fluid img-thumbnail"></a>
            </div>
         </div>
      </div>
   </div>
