...
<tbody>
    ...
    <?php $i=1; foreach($user as $user) { ?>
        ...
        <div class="icheck-primary">
                  <input type="checkbox" class="icheckbox_flat-blue " name="id_user[]" value="<?php echo $user->id ?>" id="check<?php echo $i ?>">
    ...
    <td>
        ...
        <a href="{{ asset('admin/user/edit/'.$user->id) }}" 
          ...
          <a href="{{ asset('admin/user/delete/'.$user->id) }}" class="btn btn-danger btn-sm  delete-link">
