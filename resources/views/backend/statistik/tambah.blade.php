    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('admin/statistik/tambah') }}" method="post" accept-charset="utf-8">
                    {{ csrf_field() }}

                    <div class="form-group row">
                        <label class="col-md-3 text-right">Judul</label>
                        <div class="col-md-9">
                            <input type="text" name="inp_title" class="form-control" placeholder="Judul" value="" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="inp_value" class="form-control" placeholder="Nilai" value="" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="inp_subtitle" class="form-control" placeholder="Text Nilai" value="" required>
