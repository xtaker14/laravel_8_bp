...
<div class="form-group row">
	...
	<div class="col-sm-9">
		...
		<small class="text-gray">Contoh: <span class="text-success">https://www.youtube.com/watch?v=</span><strong class="text-danger">LVueE0wTuv8</strong>.
							<br>Copy kode <strong class="text-danger">LVueE0wTuv8</strong> sebagai kode Youtube.</small>
	</div>
</div>
